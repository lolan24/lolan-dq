...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002340509267 -1002165178408 -1002334147651').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = [int(auth_channel) for auth_channel in environ.get('AUTH_CHANNEL', '-1001953506128').split() if id_pattern.search(auth_channel)]
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+vtv9HBpl3TUyMWI9')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+prFBhj1ARkk2MjZl')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002340509267 -1002141533566')).split()]
